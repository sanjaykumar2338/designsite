          ...
          <div class="col-md-12">
            <form method="post" enctype="multipart/form-data" action="{{ route('admin.collection.store') }}">
                ...
                <div class="mb-3 mt-3">
                  ...
                  <input type="text" value="" class="form-control" id="movement" placeholder="Enter Movement" name="movement">
                </div>

                <div class="mb-3 mt-3">
                  <label for="product_name">Mission:</label>
                  <input type="text" value="" class="form-control" id="mission" placeholder="Enter Mission" name="mission">
                </div>

                <div class="mb-3 mt-3">
                  <label for="product_name">Donations to:</label>
                  <input type="text" value="" class="form-control" id="title" placeholder="Enter Title" name="donations_to">
                </div>
