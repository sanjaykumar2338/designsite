          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="{{url('admin/collection/add/new')}}">Add New Collection</a></h3>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <td class="col-sm-2 col-md-2">
                                            ...
                                            <td class="col-sm-3 col-md-3" style="text-align: right">
                                              <a onclick="return confirm('Are you sure?')" href="/admin/collection/remove/{{$blog->id}}" class="btn btn-danger">Remove</a>
                                              <a href="/admin/collection/edit/{{$blog->id}}" class="btn btn-primary">EDIT</a>
                                              <a href="/admin/boycott/{{$blog->id}}" class="btn btn-primary">Manage Boycotts</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                      </table>
